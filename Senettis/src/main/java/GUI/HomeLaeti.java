...
public class HomeLaeti {
	...
	public void compositeMain() {
		...
		compositeMain.setSize(rect.width-24, rect.height-100);
	}
	...
	public void compositeColonneDroite() {
		...
		VueEmploye.compositeSelection(colonneDroite);
		VueEmploye.compositeVue(colonneDroite, shell);
	...
	public void compositeMenu() {
		...
		boutonEmploye.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				VueEmploye.vueEmployeAfficher(colonneDroite, shell);
