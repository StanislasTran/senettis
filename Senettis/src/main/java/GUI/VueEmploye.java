...
public class VueEmploye {
	...
	/***
	 * Pour créer une vueEmploye : dispose si une vueEmploye existe deja, creer le
	 * composite et lui affecte le layout RowLayout Vertical Appelle ensuite les
	 * fonctions compositeSelectionCreer et vueEmployeAfficher
	 * 
	 ...
	 * formulaire de modification d'un employe
	 * 
	...
	public void vueEmployeAfficher(Composite composite) {
		...
		final Table table = getAllEmployer(vue);
